...
export const CircularTestimonials = ({
  ...
  const colorDesignation = colors.designation ?? "var(--muted-foreground, #6b7280)";
        ...
        <div className="testimonial-content">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.p
                className="quote"
                style={{ color: colorTestimony, fontSize: fontSizeQuote, opacity: 0.85 }}
              >
          ...
          <div className="arrow-buttons">
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${colorArrowBg}`,
              }}
